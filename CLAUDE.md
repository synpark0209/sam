...
## 배포 시 필수 작업
git push 할 때마다 반드시 다음을 함께 수행:
1. **대화 로그 저장**: `docs/conversations/`에 해당 날짜 대화 내용 저장/업데이트
2. **IMPLEMENTATION.md 업데이트**: 완료/미구현 체크리스트 최신화
3. **GDD 업데이트**: 기획 변경 사항 반영 (변경 있을 때만)
