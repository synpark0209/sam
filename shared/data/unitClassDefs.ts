...
export const UNIT_CLASS_DEFS: Record<UnitClass, UnitClassDef> = {
  ...
  [UnitClass.DANCER]: {
    ...
    diagonalAttack: false,
    skillSlots: 4,
    growthRates: { maxHp: 5, attack: 1, defense: 2, speed: 3, maxMp: 5, spirit: 4 },
  },
  [UnitClass.TAOIST]: {
    id: UnitClass.TAOIST,
    name: '도사',
    ...
    diagonalAttack: false,
    skillSlots: 4,
    growthRates: { maxHp: 6, attack: 2, defense: 2, speed: 2, maxMp: 4, spirit: 4 },
  },
  [UnitClass.GEOMANCER]: {
    id: UnitClass.GEOMANCER,
    name: '풍수사',
    movementType: MovementType.FOOT,
    terrainCosts: {
      [TileType.PLAIN]: 1,
    ...
    diagonalAttack: false,
    skillSlots: 3,
    growthRates: { maxHp: 6, attack: 1, defense: 3, speed: 2, maxMp: 5, spirit: 3 },
  },
  [UnitClass.SIEGE]: {
    id: UnitClass.SIEGE,
    name: '공성차',
    movementType: MovementType.HEAVY,
    terrainCosts: {
      [TileType.PLAIN]: 1,
      [TileType.BRIDGE]: 1,
    },
    ...
    diagonalAttack: false,
    skillSlots: 1,
    growthRates: { maxHp: 12, attack: 6, defense: 5, speed: 1, maxMp: 1, spirit: 0 },
  },
};
