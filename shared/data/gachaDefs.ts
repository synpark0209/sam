...
export const GACHA_HERO_POOL: GachaHeroDef[] = [
  ...
  { id: 'gacha_guanyu', name: '관우', grade: 'UR', unitClass: UnitClass.CAVALRY,
    uniqueSkill: 'guanyu_blade', baseStats: { maxHp: 210, attack: 50, defense: 28, speed: 5, moveRange: 6, attackRange: 1, spirit: 15, agility: 25, critical: 30, morale: 50, penetration: 12, resist: 15 },
    maxMp: 20, defaultEquippedSkills: [] },
  { id: 'gacha_caocao', name: '조조', grade: 'UR', unitClass: UnitClass.INFANTRY,
    uniqueSkill: 'caocao_command', baseStats: { maxHp: 190, attack: 42, defense: 30, speed: 5, moveRange: 4, attackRange: 1, spirit: 25, agility: 22, critical: 18, morale: 50, penetration: 8, resist: 25 },
    maxMp: 25, defaultEquippedSkills: [] },
  { id: 'gacha_zhuge', name: '제갈량', grade: 'UR', unitClass: UnitClass.STRATEGIST,
    uniqueSkill: 'zhuge_plan', baseStats: { maxHp: 120, attack: 28, defense: 15, speed: 4, moveRange: 3, attackRange: 1, spirit: 55, agility: 18, critical: 10, morale: 30, penetration: 0, resist: 30 },
    maxMp: 50, defaultEquippedSkills: [] },
  { id: 'gacha_zhouyu', name: '주유', grade: 'UR', unitClass: UnitClass.STRATEGIST,
    uniqueSkill: 'zhouyu_fire', baseStats: { maxHp: 130, attack: 30, defense: 16, speed: 4, moveRange: 3, attackRange: 1, spirit: 48, agility: 22, critical: 12, morale: 30, penetration: 0, resist: 28 },
    maxMp: 45, defaultEquippedSkills: [] },
  { id: 'gacha_zhangfei', name: '장비', grade: 'UR', unitClass: UnitClass.INFANTRY,
    uniqueSkill: 'zhangfei_roar', baseStats: { maxHp: 230, attack: 48, defense: 32, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 18, critical: 25, morale: 45, penetration: 15, resist: 10 },
    maxMp: 15, defaultEquippedSkills: [] },
  { id: 'gacha_zhaoyun', name: '조운', grade: 'UR', unitClass: UnitClass.CAVALRY,
    uniqueSkill: 'zhaoyun_charge', baseStats: { maxHp: 200, attack: 52, defense: 24, speed: 6, moveRange: 6, attackRange: 1, spirit: 12, agility: 35, critical: 30, morale: 40, penetration: 10, resist: 12 },
    maxMp: 18, defaultEquippedSkills: [] },

  // ── SR ──
  { id: 'gacha_machao', name: '마초', grade: 'SSR', unitClass: UnitClass.CAVALRY,
    uniqueSkill: 'machao_fury', baseStats: { maxHp: 180, attack: 45, defense: 20, speed: 6, moveRange: 6, attackRange: 1, spirit: 8, agility: 30, critical: 28, morale: 38, penetration: 12, resist: 8 },
    maxMp: 12, defaultEquippedSkills: [] },
  { id: 'gacha_huangzhong', name: '황충', grade: 'SSR', unitClass: UnitClass.ARCHER,
    uniqueSkill: 'huang_snipe', baseStats: { maxHp: 120, attack: 42, defense: 14, speed: 5, moveRange: 3, attackRange: 3, spirit: 10, agility: 35, critical: 40, morale: 35, penetration: 10, resist: 10 },
    maxMp: 15, defaultEquippedSkills: [] },
  { id: 'gacha_huatuo', name: '화타', grade: 'SSR', unitClass: UnitClass.STRATEGIST,
    uniqueSkill: 'huatuo_heal', baseStats: { maxHp: 100, attack: 18, defense: 12, speed: 4, moveRange: 3, attackRange: 1, spirit: 50, agility: 15, critical: 5, morale: 20, penetration: 0, resist: 35 },
    maxMp: 40, defaultEquippedSkills: [] },
  { id: 'gacha_dianwei', name: '전위', grade: 'SSR', unitClass: UnitClass.MARTIAL_ARTIST,
    uniqueSkill: 'dianwei_rage', baseStats: { maxHp: 200, attack: 46, defense: 22, speed: 5, moveRange: 4, attackRange: 1, spirit: 5, agility: 22, critical: 30, morale: 45, penetration: 15, resist: 8 },
    maxMp: 12, defaultEquippedSkills: [] },
  { id: 'gacha_xuchu', name: '허저', grade: 'SSR', unitClass: UnitClass.MARTIAL_ARTIST,
    uniqueSkill: 'xuchu_naked', baseStats: { maxHp: 220, attack: 44, defense: 26, speed: 4, moveRange: 4, attackRange: 1, spirit: 5, agility: 18, critical: 25, morale: 40, penetration: 18, resist: 10 },
    maxMp: 10, defaultEquippedSkills: [] },
  { id: 'gacha_ganning', name: '감녕', grade: 'SSR', unitClass: UnitClass.BANDIT,
    uniqueSkill: 'ganning_raid', baseStats: { maxHp: 150, attack: 40, defense: 16, speed: 7, moveRange: 5, attackRange: 1, spirit: 8, agility: 38, critical: 35, morale: 30, penetration: 15, resist: 8 },
    maxMp: 12, defaultEquippedSkills: [] },
  { id: 'gacha_pangtong', name: '방통', grade: 'SSR', unitClass: UnitClass.STRATEGIST,
    uniqueSkill: 'pangtong_chain', baseStats: { maxHp: 110, attack: 25, defense: 14, speed: 3, moveRange: 3, attackRange: 1, spirit: 45, agility: 16, critical: 10, morale: 25, penetration: 0, resist: 28 },
    maxMp: 35, defaultEquippedSkills: [] },
  { id: 'gacha_xunyu', name: '순욱', grade: 'SSR', unitClass: UnitClass.STRATEGIST,
    uniqueSkill: 'xunyu_strategy', baseStats: { maxHp: 100, attack: 20, defense: 12, speed: 4, moveRange: 3, attackRange: 1, spirit: 42, agility: 14, critical: 8, morale: 22, penetration: 0, resist: 30 },
    maxMp: 40, defaultEquippedSkills: [] },

  // ── A ──
  { id: 'gacha_caoren', name: '조인', grade: 'SR', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 160, attack: 35, defense: 25, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 10, defaultEquippedSkills: [] },
  { id: 'gacha_caohong', name: '조홍', grade: 'SR', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 150, attack: 38, defense: 18, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_lidian', name: '이전', grade: 'SR', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 145, attack: 34, defense: 22, speed: 5, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 10, defaultEquippedSkills: [] },
  { id: 'gacha_yuejin', name: '악진', grade: 'SR', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 140, attack: 36, defense: 20, speed: 5, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_wenchou', name: '문추', grade: 'SR', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 155, attack: 40, defense: 16, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_yanliang', name: '안량', grade: 'SR', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 155, attack: 42, defense: 14, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_huangge', name: '황개', grade: 'SR', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 150, attack: 34, defense: 24, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 10, defaultEquippedSkills: [] },
  { id: 'gacha_chengpu', name: '정보', grade: 'SR', unitClass: UnitClass.ARCHER,
    baseStats: { maxHp: 110, attack: 32, defense: 14, speed: 5, moveRange: 3, attackRange: 2, spirit: 10, agility: 30, critical: 28, morale: 25, penetration: 8, resist: 10 },
    maxMp: 12, defaultEquippedSkills: [] },
  ...
  { id: 'gacha_xiahoumao', name: '하후무', grade: 'R', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 130, attack: 30, defense: 14, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 6, defaultEquippedSkills: [] },
  { id: 'gacha_caozhen', name: '조진', grade: 'R', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 135, attack: 28, defense: 20, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 6, defaultEquippedSkills: [] },
  { id: 'gacha_yujin', name: '우금', grade: 'R', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 130, attack: 26, defense: 22, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 6, defaultEquippedSkills: [] },
  ...
  { id: 'gacha_liyan', name: '이엄', grade: 'R', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 128, attack: 28, defense: 20, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 6, defaultEquippedSkills: [] },
  ...
  { id: 'gacha_zhoutai', name: '주태', grade: 'R', unitClass: UnitClass.INFANTRY,
    baseStats: { maxHp: 140, attack: 30, defense: 22, speed: 4, moveRange: 4, attackRange: 1, spirit: 8, agility: 20, critical: 20, morale: 35, penetration: 10, resist: 20 },
    maxMp: 6, defaultEquippedSkills: [] },
  { id: 'gacha_panzh', name: '반장', grade: 'R', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 125, attack: 30, defense: 12, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 6, defaultEquippedSkills: [] },
  { id: 'gacha_handang', name: '한당', grade: 'R', unitClass: UnitClass.ARCHER,
    baseStats: { maxHp: 90, attack: 26, defense: 10, speed: 5, moveRange: 3, attackRange: 2, spirit: 8, agility: 28, critical: 22, morale: 22, penetration: 6, resist: 8 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_zhangren', name: '장임', grade: 'R', unitClass: UnitClass.ARCHER,
    baseStats: { maxHp: 88, attack: 28, defense: 10, speed: 5, moveRange: 3, attackRange: 2, spirit: 8, agility: 25, critical: 20, morale: 20, penetration: 6, resist: 8 },
    maxMp: 8, defaultEquippedSkills: [] },
  { id: 'gacha_gaolan', name: '고람', grade: 'R', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 128, attack: 32, defense: 12, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 6, defaultEquippedSkills: [] },
  ...
  { id: 'gacha_zhangxiu', name: '장수', grade: 'R', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 132, attack: 32, defense: 14, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 6, defaultEquippedSkills: [] },
  { id: 'gacha_gongsunzan', name: '공손찬', grade: 'R', unitClass: UnitClass.CAVALRY,
    baseStats: { maxHp: 135, attack: 30, defense: 16, speed: 5, moveRange: 6, attackRange: 1, spirit: 8, agility: 28, critical: 25, morale: 35, penetration: 10, resist: 10 },
    maxMp: 6, defaultEquippedSkills: [] },
];
