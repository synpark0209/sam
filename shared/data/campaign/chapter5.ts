...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e10_1', '도적단장', UnitClass.BANDIT, 10, 4, 10, { maxHp: 240, hp: 240, attack: 55 }),
    enemy('e10_2', '도적', UnitClass.BANDIT, 9, 2, 9),
    enemy('e10_3', '도적', UnitClass.BANDIT, 9, 7, 9),
    enemy('e10_4', '도적', UnitClass.INFANTRY, 10, 3, 8),
    enemy('e10_5', '도적', UnitClass.INFANTRY, 10, 6, 8),
    enemy('e10_6', '도적', UnitClass.BANDIT, 8, 5, 8),
  ],
