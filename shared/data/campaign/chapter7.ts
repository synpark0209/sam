...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e7_1', '유비 수비대장', UnitClass.INFANTRY, 9, 4, 12, { maxHp: 240, hp: 240, attack: 60, defense: 40 }),
    enemy('e7_2', '유비군 보병', UnitClass.INFANTRY, 8, 3, 11),
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e7_7', '조조 선봉 보병', UnitClass.INFANTRY, 9, 3, 12),
    enemy('e7_8', '조조 선봉 보병', UnitClass.INFANTRY, 9, 6, 12),
    enemy('e7_9', '조조 선봉 기병', UnitClass.CAVALRY, 10, 2, 12),
    enemy('e7_10', '조조 선봉 기병', UnitClass.CAVALRY, 10, 7, 12),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 3 }, { x: 1, y: 5 }, { x: 2, y: 4 }],
};
...
const stage3Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e7_11', '조조 야영 보병', UnitClass.INFANTRY, 7, 2, 12),
    enemy('e7_12', '조조 야영 보병', UnitClass.INFANTRY, 8, 4, 12),
    enemy('e7_13', '조조 야영 궁병', UnitClass.ARCHER, 7, 6, 12),
    enemy('e7_14', '조조 야영 궁병', UnitClass.ARCHER, 8, 7, 12),
    enemy('e7_15', '조조 야영 보병', UnitClass.INFANTRY, 9, 5, 12),
    enemy('e7_16', '조조 참모', UnitClass.STRATEGIST, 9, 3, 12, { maxHp: 160, hp: 160, spirit: 55 }),
  ],
