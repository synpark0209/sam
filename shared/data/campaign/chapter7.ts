...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e7_1', '관우', UnitClass.CAVALRY, 9, 4, 13, { maxHp: 280, hp: 280, attack: 65, defense: 35 }),
    enemy('e7_2', '장비', UnitClass.INFANTRY, 8, 3, 12, { maxHp: 260, hp: 260, attack: 60, defense: 30 }),
    enemy('e7_3', '유비군 보병', UnitClass.INFANTRY, 8, 6, 11),
    enemy('e7_4', '유비군 궁병', UnitClass.ARCHER, 10, 4, 11),
    enemy('e7_5', '유비군 궁병', UnitClass.ARCHER, 10, 5, 11),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e7_6', '하후돈', UnitClass.INFANTRY, 10, 4, 14, { maxHp: 300, hp: 300, attack: 75, defense: 45 }),
    enemy('e7_7', '조조군 선봉보병', UnitClass.INFANTRY, 9, 3, 12),
    enemy('e7_8', '조조군 선봉보병', UnitClass.INFANTRY, 9, 6, 12),
    enemy('e7_9', '조조군 선봉기병', UnitClass.CAVALRY, 10, 2, 12),
    enemy('e7_10', '조조군 선봉기병', UnitClass.CAVALRY, 10, 7, 12),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 3 }, { x: 1, y: 5 }, { x: 2, y: 4 }],
};
...
const stage3Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e7_11', '조조군 야영보병', UnitClass.INFANTRY, 7, 2, 12),
    enemy('e7_12', '조조군 야영보병', UnitClass.INFANTRY, 8, 4, 12),
    enemy('e7_13', '조조군 야영궁병', UnitClass.ARCHER, 7, 6, 12),
    enemy('e7_14', '조조군 야영궁병', UnitClass.ARCHER, 8, 7, 12),
    enemy('e7_15', '조조군 야영보병', UnitClass.INFANTRY, 9, 5, 12),
    enemy('e7_16', '곽가', UnitClass.STRATEGIST, 9, 3, 13, { maxHp: 180, hp: 180, spirit: 60 }),
  ],
