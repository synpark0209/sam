    ...
    },
    {
      ...
      rewards: {
        ...
        recruitUnits: [{
          ...
          position: { x: 0, y: 0 },
          stats: { maxHp: 264, hp: 264, attack: 56, defense: 51, spirit: 18, agility: 26, critical: 23, morale: 53, speed: 3, penetration: 10, resist: 33, moveRange: 4, attackRange: 1 },
