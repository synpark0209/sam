...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e9_6b', '반란군 궁병', UnitClass.ARCHER, 9, 4, 26),
    enemy('e9_6c', '반란군 기병', UnitClass.CAVALRY, 5, 3, 25),
    enemy('e9_6d', '반란군 보병', UnitClass.INFANTRY, 9, 6, 25),
    enemy('e9_6e', '반란군 궁병', UnitClass.ARCHER, 6, 4, 25),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e9_15', '조조군 궁병', UnitClass.ARCHER, 11, 3, 26),
    enemy('e9_16', '조조군 궁병', UnitClass.ARCHER, 11, 6, 26),
    enemy('e9_17', '조조군 보병', UnitClass.INFANTRY, 7, 4, 26),
    enemy('e9_18', '조조군 군사', UnitClass.STRATEGIST, 6, 4, 27),
  ],
...
export const CHAPTER_9: Chapter = {
  ...
  stages: [
    ...
    },
    {
      ...
      rewards: {
        gold: 1500, items: ['serpent_spear', 'dragon_armor'],
        recruitUnits: [{
          id: 'p8', name: '후성', faction: 'player', unitClass: UnitClass.BANDIT,
          grade: 'R', isScenarioUnit: true,
          level: 25, exp: 0, mp: 15, maxMp: 15,
          classSkillId: 'class_bandit_1',
          uniqueSkill: 'housheng_ambush', uniqueSkillUnlocked: false,
          equippedSkills: [], promotionLevel: 0,
          equipment: { weapon: 'shadow_blade', armor: 'night_garb' },
          position: { x: 0, y: 0 },
          stats: { maxHp: 230, hp: 230, attack: 72, defense: 38, spirit: 22, agility: 50, critical: 55, morale: 35, speed: 7, penetration: 15, resist: 20, moveRange: 5, attackRange: 1 },
