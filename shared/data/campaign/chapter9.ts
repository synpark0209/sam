...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e9_4', '반란군', UnitClass.INFANTRY, 6, 3, 13),
    enemy('e9_5', '반란군', UnitClass.INFANTRY, 6, 6, 13),
    enemy('e9_6', '반란군', UnitClass.INFANTRY, 8, 6, 13),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e9_11', '조조군', UnitClass.INFANTRY, 9, 2, 15),
    enemy('e9_12', '조조군', UnitClass.CAVALRY, 9, 7, 15),
    enemy('e9_13', '조조군', UnitClass.INFANTRY, 10, 1, 15),
    enemy('e9_14', '조조군', UnitClass.CAVALRY, 10, 8, 15),
  ],
