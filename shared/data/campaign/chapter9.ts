...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e9_1', '후성', UnitClass.CAVALRY, 7, 4, 14, { maxHp: 260, hp: 260, attack: 55 }),
    enemy('e9_2', '위속', UnitClass.INFANTRY, 7, 5, 14, { maxHp: 250, hp: 250, attack: 52 }),
    enemy('e9_3', '송헌', UnitClass.ARCHER, 8, 3, 14, { maxHp: 200, hp: 200, attack: 48 }),
    enemy('e9_4', '반란군 보병', UnitClass.INFANTRY, 6, 3, 13),
    enemy('e9_5', '반란군 보병', UnitClass.INFANTRY, 6, 6, 13),
    enemy('e9_6', '반란군 보병', UnitClass.INFANTRY, 8, 6, 13),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e9_7', '조조', UnitClass.STRATEGIST, 10, 4, 18, { maxHp: 280, hp: 280, attack: 48, spirit: 65 }),
    enemy('e9_8', '허저', UnitClass.MARTIAL_ARTIST, 8, 3, 16, { maxHp: 300, hp: 300, attack: 62 }),
    enemy('e9_9', '전위', UnitClass.MARTIAL_ARTIST, 8, 6, 16, { maxHp: 290, hp: 290, attack: 60 }),
    enemy('e9_10', '하후돈', UnitClass.INFANTRY, 7, 1, 16, { maxHp: 280, hp: 280, attack: 55 }),
    enemy('e9_11', '조조군 보병', UnitClass.INFANTRY, 9, 2, 15),
    enemy('e9_12', '조조군 기병', UnitClass.CAVALRY, 9, 7, 15),
    enemy('e9_13', '조조군 보병', UnitClass.INFANTRY, 10, 1, 15),
    enemy('e9_14', '조조군 기병', UnitClass.CAVALRY, 10, 8, 15),
  ],
