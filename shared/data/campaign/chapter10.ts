...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e10_2', '잔적', UnitClass.BANDIT, 8, 3, 15),
    enemy('e10_3', '잔적', UnitClass.BANDIT, 8, 5, 15),
    enemy('e10_4', '잔적', UnitClass.INFANTRY, 9, 2, 14),
    enemy('e10_5', '잔적', UnitClass.INFANTRY, 9, 7, 14),
    enemy('e10_6', '잔적', UnitClass.BANDIT, 10, 4, 15),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e10_10', '조조 정예', UnitClass.CAVALRY, 10, 1, 17),
    enemy('e10_11', '조조 정예', UnitClass.CAVALRY, 10, 8, 17),
    enemy('e10_12', '조조 정예', UnitClass.INFANTRY, 8, 5, 16),
    enemy('e10_13', '조조 정예', UnitClass.ARCHER, 10, 6, 16),
    enemy('e10_14', '조조 정예', UnitClass.INFANTRY, 8, 2, 16),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 5 }, { x: 2, y: 3 }, { x: 2, y: 6 }],
};
