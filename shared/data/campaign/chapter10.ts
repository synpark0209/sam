...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e10_1', '잔적 수괴', UnitClass.BANDIT, 9, 4, 16, { maxHp: 280, hp: 280, attack: 55 }),
    enemy('e10_2', '잔적 도적', UnitClass.BANDIT, 8, 3, 15),
    enemy('e10_3', '잔적 도적', UnitClass.BANDIT, 8, 5, 15),
    enemy('e10_4', '잔적 보병', UnitClass.INFANTRY, 9, 2, 14),
    enemy('e10_5', '잔적 보병', UnitClass.INFANTRY, 9, 7, 14),
    enemy('e10_6', '잔적 도적', UnitClass.BANDIT, 10, 4, 15),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e10_7', '조조', UnitClass.STRATEGIST, 10, 4, 20, { maxHp: 320, hp: 320, attack: 55, spirit: 75 }),
    enemy('e10_8', '허저', UnitClass.MARTIAL_ARTIST, 9, 4, 18, { maxHp: 340, hp: 340, attack: 68 }),
    enemy('e10_9', '하후돈', UnitClass.INFANTRY, 9, 2, 18, { maxHp: 320, hp: 320, attack: 62 }),
    enemy('e10_10', '하후연', UnitClass.CAVALRY, 10, 1, 18, { maxHp: 310, hp: 310, attack: 65 }),
    enemy('e10_11', '악진', UnitClass.CAVALRY, 10, 8, 17, { maxHp: 290, hp: 290, attack: 60 }),
    enemy('e10_12', '조조군 정예보병', UnitClass.INFANTRY, 8, 5, 16),
    enemy('e10_13', '조조군 정예궁병', UnitClass.ARCHER, 10, 6, 16),
    enemy('e10_14', '조조군 정예보병', UnitClass.INFANTRY, 8, 2, 16),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 5 }, { x: 2, y: 3 }, { x: 2, y: 6 }],
};
...
const stage3Battle: BattleConfig = {
  ...
  enemyUnits: [
    enemy('e10_15', '관우', UnitClass.CAVALRY, 10, 4, 22, { maxHp: 400, hp: 400, attack: 78, defense: 40, morale: 50 }),
    enemy('e10_16', '유비', UnitClass.CAVALRY, 9, 4, 20, { maxHp: 320, hp: 320, attack: 60, morale: 45 }),
    enemy('e10_17', '장비', UnitClass.INFANTRY, 10, 5, 20, { maxHp: 380, hp: 380, attack: 72, defense: 35 }),
    enemy('e10_18', '제갈량', UnitClass.STRATEGIST, 8, 4, 20, { maxHp: 280, hp: 280, attack: 45, spirit: 80 }),
    enemy('e10_19', '조운', UnitClass.CAVALRY, 9, 2, 20, { maxHp: 360, hp: 360, attack: 68, agility: 40 }),
    enemy('e10_20', '손권', UnitClass.STRATEGIST, 8, 7, 18, { maxHp: 260, hp: 260, attack: 40, spirit: 65 }),
    enemy('e10_21', '주유', UnitClass.STRATEGIST, 9, 7, 20, { maxHp: 270, hp: 270, attack: 42, spirit: 75 }),
    enemy('e10_22', '손책', UnitClass.CAVALRY, 10, 7, 18, { maxHp: 340, hp: 340, attack: 65, agility: 35 }),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 5 }, { x: 2, y: 3 }, { x: 2, y: 6 }],
};
