...
const stage1Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e10_6b', '잔적 궁수', UnitClass.ARCHER, 10, 6, 28),
    enemy('e10_6c', '잔적 무사', UnitClass.MARTIAL_ARTIST, 11, 3, 29),
    enemy('e10_6d', '잔적 보병', UnitClass.INFANTRY, 11, 5, 28),
    enemy('e10_6e', '잔적 궁수', UnitClass.ARCHER, 7, 4, 27),
  ],
...
const stage2Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e10_14b', '조조군 정예기병', UnitClass.CAVALRY, 10, 2, 29),
    enemy('e10_14c', '조조군 정예궁병', UnitClass.ARCHER, 11, 5, 28),
    enemy('e10_14d', '조조군 정예보병', UnitClass.INFANTRY, 8, 6, 28),
    enemy('e10_14e', '조조군 군사', UnitClass.STRATEGIST, 11, 3, 30),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 5 }, { x: 2, y: 3 }, { x: 2, y: 6 }, { x: 1, y: 2 }, { x: 2, y: 2 }, { x: 3, y: 2 }, { x: 4, y: 2 }],
};
...
const stage3Battle: BattleConfig = {
  ...
  enemyUnits: [
    ...
    enemy('e10_23', '황충', UnitClass.ARCHER, 10, 2, 33, { maxHp: 420, hp: 420, attack: 82, defense: 28 }),
    enemy('e10_24', '마초', UnitClass.CAVALRY, 9, 1, 34, { maxHp: 500, hp: 500, attack: 88, defense: 32, agility: 40 }),
    enemy('e10_25', '연합군 보병', UnitClass.INFANTRY, 8, 2, 31),
    enemy('e10_26', '연합군 보병', UnitClass.INFANTRY, 8, 6, 31),
    enemy('e10_27', '연합군 궁병', UnitClass.ARCHER, 11, 4, 30),
    enemy('e10_28', '연합군 기병', UnitClass.CAVALRY, 11, 3, 31),
  ],
  playerStartPositions: [{ x: 1, y: 4 }, { x: 1, y: 5 }, { x: 2, y: 3 }, { x: 2, y: 6 }, { x: 1, y: 2 }, { x: 2, y: 2 }, { x: 3, y: 2 }, { x: 4, y: 2 }],
};
