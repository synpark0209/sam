    ...
    },
    {
      ...
      rewards: {
        ...
        recruitUnits: [{
          ...
          position: { x: 0, y: 0 },
          stats: { maxHp: 150, hp: 150, attack: 35, defense: 22, spirit: 60, agility: 30, critical: 20, morale: 55, speed: 5, penetration: 3, resist: 40, moveRange: 4, attackRange: 3 },
