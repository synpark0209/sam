...
const GACHA_POOL: GachaHero[] = [
  // UR
  { id: 'gacha_guanyu', name: '관우', grade: 'UR', unitClass: 'cavalry', uniqueSkill: 'guanyu_blade', baseStats: { maxHp: 210, attack: 50, defense: 28, speed: 5, moveRange: 6, attackRange: 1 }, maxMp: 20, defaultEquippedSkills: ['charge', 'encourage'] },
  { id: 'gacha_caocao', name: '조조', grade: 'UR', unitClass: 'infantry', uniqueSkill: 'caocao_command', baseStats: { maxHp: 190, attack: 42, defense: 30, speed: 5, moveRange: 4, attackRange: 1 }, maxMp: 25, defaultEquippedSkills: ['encourage', 'fortify'] },
  { id: 'gacha_zhuge', name: '제갈량', grade: 'UR', unitClass: 'strategist', uniqueSkill: 'zhuge_plan', baseStats: { maxHp: 120, attack: 28, defense: 15, speed: 4, moveRange: 3, attackRange: 1 }, maxMp: 50, defaultEquippedSkills: ['fire', 'heal', 'water'] },
  { id: 'gacha_zhouyu', name: '주유', grade: 'UR', unitClass: 'strategist', uniqueSkill: 'zhouyu_fire', baseStats: { maxHp: 130, attack: 30, defense: 16, speed: 4, moveRange: 3, attackRange: 1 }, maxMp: 45, defaultEquippedSkills: ['fire', 'water'] },
  { id: 'gacha_zhangfei', name: '장비', grade: 'UR', unitClass: 'infantry', uniqueSkill: 'zhangfei_roar', baseStats: { maxHp: 230, attack: 48, defense: 32, speed: 4, moveRange: 4, attackRange: 1 }, maxMp: 15, defaultEquippedSkills: ['fortify'] },
  { id: 'gacha_zhaoyun', name: '조운', grade: 'UR', unitClass: 'cavalry', uniqueSkill: 'zhaoyun_charge', baseStats: { maxHp: 200, attack: 52, defense: 24, speed: 6, moveRange: 6, attackRange: 1 }, maxMp: 18, defaultEquippedSkills: ['charge'] },
  // SSR
  { id: 'gacha_machao', name: '마초', grade: 'SSR', unitClass: 'cavalry', uniqueSkill: 'machao_fury', baseStats: { maxHp: 180, attack: 45, defense: 20, speed: 6, moveRange: 6, attackRange: 1 }, maxMp: 12, defaultEquippedSkills: ['charge'] },
  { id: 'gacha_huangzhong', name: '황충', grade: 'SSR', unitClass: 'archer', uniqueSkill: 'huang_snipe', baseStats: { maxHp: 120, attack: 42, defense: 14, speed: 5, moveRange: 3, attackRange: 3 }, maxMp: 15, defaultEquippedSkills: ['arrow_rain'] },
  { id: 'gacha_huatuo', name: '화타', grade: 'SSR', unitClass: 'strategist', uniqueSkill: 'huatuo_heal', baseStats: { maxHp: 100, attack: 18, defense: 12, speed: 4, moveRange: 3, attackRange: 1 }, maxMp: 40, defaultEquippedSkills: ['heal', 'group_heal'] },
  { id: 'gacha_dianwei', name: '전위', grade: 'SSR', unitClass: 'martial_artist', uniqueSkill: 'dianwei_rage', baseStats: { maxHp: 200, attack: 46, defense: 22, speed: 5, moveRange: 4, attackRange: 1 }, maxMp: 12, defaultEquippedSkills: ['encourage'] },
  { id: 'gacha_xuchu', name: '허저', grade: 'SSR', unitClass: 'martial_artist', uniqueSkill: 'xuchu_naked', baseStats: { maxHp: 220, attack: 44, defense: 26, speed: 4, moveRange: 4, attackRange: 1 }, maxMp: 10, defaultEquippedSkills: ['fortify'] },
  { id: 'gacha_ganning', name: '감녕', grade: 'SSR', unitClass: 'bandit', uniqueSkill: 'ganning_raid', baseStats: { maxHp: 150, attack: 40, defense: 16, speed: 7, moveRange: 5, attackRange: 1 }, maxMp: 12, defaultEquippedSkills: ['confuse'] },
  { id: 'gacha_pangtong', name: '방통', grade: 'SSR', unitClass: 'strategist', uniqueSkill: 'pangtong_chain', baseStats: { maxHp: 110, attack: 25, defense: 14, speed: 3, moveRange: 3, attackRange: 1 }, maxMp: 35, defaultEquippedSkills: ['fire', 'confuse'] },
  { id: 'gacha_xunyu', name: '순욱', grade: 'SSR', unitClass: 'strategist', uniqueSkill: 'xunyu_strategy', baseStats: { maxHp: 100, attack: 20, defense: 12, speed: 4, moveRange: 3, attackRange: 1 }, maxMp: 40, defaultEquippedSkills: ['heal', 'encourage'] },
  // SR
  { id: 'gacha_caoren', name: '조인', grade: 'SR', unitClass: 'infantry', baseStats: { maxHp: 160, attack: 35, defense: 25, speed: 4, moveRange: 4, attackRange: 1 }, maxMp: 10, defaultEquippedSkills: ['fortify'] },
  { id: 'gacha_caohong', name: '조홍', grade: 'SR', unitClass: 'cavalry', baseStats: { maxHp: 150, attack: 38, defense: 18, speed: 5, moveRange: 6, attackRange: 1 }, maxMp: 8, defaultEquippedSkills: ['charge'] },
  { id: 'gacha_lidian', name: '이전', grade: 'SR', unitClass: 'infantry', baseStats: { maxHp: 145, attack: 34, defense: 22, speed: 5, moveRange: 4, attackRange: 1 }, maxMp: 10, defaultEquippedSkills: ['encourage'] },
  ...
  { id: 'gacha_wenchou', name: '문추', grade: 'SR', unitClass: 'cavalry', baseStats: { maxHp: 155, attack: 40, defense: 16, speed: 5, moveRange: 6, attackRange: 1 }, maxMp: 8, defaultEquippedSkills: ['charge'] },
  ...
  { id: 'gacha_chengpu', name: '정보', grade: 'SR', unitClass: 'archer', baseStats: { maxHp: 110, attack: 32, defense: 14, speed: 5, moveRange: 3, attackRange: 2 }, maxMp: 12, defaultEquippedSkills: ['arrow_rain'] },
];
